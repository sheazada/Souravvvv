...
export default function DeliveryStopsSectionLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  const routeMeta = getAdminRouteMeta('deliveryStops');
  return (
    <AdminRouteGuard
      requiredPermissions={getAdminRoutePermissions('deliveryStops')}
      loadingFallback={
        <div>
          <PageHeader
