...
export const ADMIN_ROUTE_REGISTRY = {
  ...
  pricing: {
    permissions: [permissions.productsManage],
    title: 'Price Books & Promos',
    pageTitle: 'Price Books & Promotional Schemes Engine',
    pageDescription: 'Configure tier-based retailer price books, volume discount schemes, and test live pricing rules.',
    detailTitlePrefix: 'Price Book',
    detailPageDescription: 'Review price book rules.',
    loadingDescription: 'Checking permissions for pricing master.',
    unauthorizedDescription: 'You need product permissions to manage pricing schemes.',
  },
  forecasting: {
    permissions: [permissions.dashboardRead],
    title: 'AI & Forecasting',
    pageTitle: 'AI & Demand Forecasting Intelligence Layer',
    pageDescription: 'Statistical demand predictions, natural language business assistant, voice order parser, and OCR invoice extraction.',
    detailTitlePrefix: 'AI Forecast',
    detailPageDescription: 'Review AI forecast prediction details.',
    loadingDescription: 'Checking permissions for AI forecasting.',
    unauthorizedDescription: 'You need dashboard permissions to access AI forecasting.',
  },
  backups: {
    permissions: [permissions.usersManage],
    title: 'Database Backups',
    pageTitle: 'Database Backup & Disaster Recovery Scheduler',
    pageDescription: 'Automated PostgreSQL backup snapshots uploaded to cloud storage with 1-click restore simulation.',
    detailTitlePrefix: 'Backup',
    detailPageDescription: 'Review database backup archives.',
    loadingDescription: 'Checking permissions for database backups.',
    unauthorizedDescription: 'You need system administration permissions to manage backups.',
  },
  organization: {
    permissions: [permissions.usersManage],
    title: 'Organization Legal Profile',
    pageTitle: 'Organization Profile & Documents Repository',
    pageDescription: 'Manage legal distributor registration, operating timezone, currency, and official attachments.',
    detailTitlePrefix: 'Organization Profile',
    detailPageDescription: 'Review organization profile settings.',
    loadingDescription: 'Checking permissions for organization profile.',
    unauthorizedDescription: 'You need system management permissions to manage organization profile.',
  },
  deliveryCycles: {
    permissions: [permissions.dispatchManage],
    title: 'Delivery Cycles & Cut-offs',
    pageTitle: 'Delivery Cycles & Cut-off Management Master',
    pageDescription: 'Configure daily dispatch shift windows, enforce order cutoff times, and resolve shift closures.',
    detailTitlePrefix: 'Delivery Cycle',
    detailPageDescription: 'Review delivery cycle window settings.',
    loadingDescription: 'Checking permissions for delivery cycles.',
    unauthorizedDescription: 'You need dispatch permissions to manage delivery cycles.',
  },
  sync: {
    permissions: [permissions.usersManage],
    title: 'Offline Sync Center',
    pageTitle: 'Offline Background Synchronization & Conflict Center',
    pageDescription: 'Monitor PWA offline device events, audit background sync telemetry, and resolve field update conflicts.',
    detailTitlePrefix: 'Sync Center',
    detailPageDescription: 'Review offline sync telemetry details.',
    loadingDescription: 'Checking permissions for offline sync center.',
    unauthorizedDescription: 'You need system administration permissions to access offline sync telemetry.',
  },
